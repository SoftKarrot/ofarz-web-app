...
const saveRole = (role) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post('/api/role', role)
...
const updateRole = (role, roleId) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.put('/api/role/' + roleId, role)
...
const detailsRole = (roleId) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get("/api/role/" + roleId)
...
const deleteRole = (roleId) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.delete("/api/role/" + roleId)
