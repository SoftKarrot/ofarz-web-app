...
import { PRODUCTTYPE_DELETE_FAIL, PRODUCTTYPE_DELETE_REQUEST, PRODUCTTYPE_DELETE_SUCCESS, PRODUCTTYPE_DETAILS_FAIL, PRODUCTTYPE_DETAILS_REQUEST, PRODUCTTYPE_DETAILS_SUCCESS, PRODUCTTYPE_LIST_FAIL, PRODUCTTYPE_LIST_REQUEST, PRODUCTTYPE_LIST_SUCCESS, PRODUCTTYPE_SAVE_FAIL, PRODUCTTYPE_SAVE_REQUEST, PRODUCTTYPE_SAVE_SUCCESS, PRODUCTTYPE_UPDATE_REQUEST, PRODUCTTYPE_UPDATE_SUCCESS } from '../constants/productTypeConstants';
...
const saveProductType = (producType) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post('/api/producttypes', producType)
