...
const saveDistrict = (district) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post('/api/districts', district)
...
const updateDistrict = (district, districtId) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.put('/api/districts/' + districtId, district)
...
const detailsDistrict = (districtId) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get("/api/districts/" + districtId)
...
const deleteDistrict = (districtId) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.delete("/api/districts/" + districtId)
