...
const saveDivision = (division) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post('/api/divisions', division)
...
const updateDivision = (division, divisionId) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.put('/api/divisions/' + divisionId, division)
...
const deleteDivision = (divisionId) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.delete("/api/divisions/" + divisionId)
