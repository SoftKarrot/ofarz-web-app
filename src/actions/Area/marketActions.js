...
const saveMarket = (market) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post('/api/markets', market)
...
const updateMarket = (market, marketId) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.put('/api/markets/' + marketId, market)
...
const deleteMarket = (marketId) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.delete("/api/markets/" + marketId)
