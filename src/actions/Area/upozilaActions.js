...
const listUpozilas = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get("/api/upozilas");
...
const saveUpozila = (upozila) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post('/api/upozilas', upozila)
...
const updateUpozila = (upozila, upozilaId) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.put('/api/upozilas/' + upozilaId, upozila)
...
const detailsUpozila = (upozilaId) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get("/api/upozilas/" + upozilaId)
...
const deleteUpozila = (upozilaId) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.delete("/api/upozilas/" + upozilaId)
