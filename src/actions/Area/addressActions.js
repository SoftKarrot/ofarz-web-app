...
const listDivisions = (countryId) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get("/api/address/getdivisions/" + countryId);
...
const listDistricts = (divisionId) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get("/api/address/getdistricts/" + divisionId);
...
const listUpozilas = (districtId) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get("/api/address/getdistricts/" + districtId);
...
const listUnions = (upozilaIDd) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get("/api/address/getunions/" + upozilaIDd);
...
const listMarkets = (unionId) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get("/api/address/getmarkets/" + unionId);
